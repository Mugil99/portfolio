    ...
    return (
        <div className='About' id='About'>
            <div className='About__Col1'>
                ...
                <p>I'm Mugilyalini, an Engineering graduate turned Web Developer. My interests are in <b>Front End Development</b>. This includes <b>JavaScript</b>, building responsive Single-Page-Apps (SPA) in <b>React.js</b> and good front-end coding skills.</p>
            </div>
